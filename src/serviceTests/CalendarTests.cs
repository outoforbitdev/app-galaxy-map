...
public class CalendarTests
{
    ...
    private static Calendar testCalendar { get; } =
        new Calendar(
            testInstance,
            "id",
            "Test",
    ...
    private static Calendar testCalendarNoZeroYear { get; } =
        new Calendar(
            testInstance,
            "id",
            "Test",
    ...
    private static DateTime AfterEpochDateTime { get; } =
        new DateTime((Epoch + DaysPerYear + 50) * HoursPerDay * MinutesPerHour + 245);
    private static DateTime ZeroYearDateTime { get; } =
        new DateTime((Epoch + 50) * HoursPerDay * MinutesPerHour + 245);
    private static DateTime BeforeEpochDateTime { get; } =
        new DateTime(-100 * HoursPerDay * MinutesPerHour + 245);
    ...
    public static IEnumerable<object[]> GetDateValidData =>
        new List<object[]>
        {
            ...
            {
                testCalendar,
                new DateTime(((long)Date.Max + 1) * 24 * 60 - 1),
                MaxDate,
            },
    ...
    public static IEnumerable<object[]> GetDateStringDateData =>
        new List<object[]>
        {
            ...
            {
                "2:50",
                testCalendarNoZeroYear,
                AfterEpochDate,
                DateFormat.YearColonDay,
            },
    ...
    public void GetDateString_Date_IsCorrect(
        string expected,
        Calendar calendar,
        Date date,
        DateFormat format
    ...
    public void GetDateString_DateTime_IsCorrect(
        string expected,
        Calendar calendar,
        DateTime dateTime,
        DateFormat format
    ...
    public void GetTimeString_DateTime_IsCorrect(
        string expected,
        Calendar calendar,
        DateTime dateTime
    )
