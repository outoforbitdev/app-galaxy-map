...
namespace GalaxyMapSiteApi.Migrations
{
    ...
    [Migration("20250912022103_OrbitingBodies")]
    partial class OrbitingBodies
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GalaxyMapSiteApi.Models.OrbitingBody", b =>
                {
                    b.Property<string>("InstanceId")
                        .HasColumnType("text")
                        .HasColumnName("instance_id");
                    ...
                    b.Property<string>("OrbitedBodyId")
                        .HasColumnType("text")
                        .HasColumnName("orbited_body_id");
                    ...
                    b.HasKey("InstanceId", "Id")
                        .HasName("pk_orbiting_bodies");

                    b.HasIndex("InstanceId", "OrbitedBodyId")
                        .HasDatabaseName("ix_orbiting_bodies_instance_id_orbited_body_id");

                    b.HasIndex("InstanceId", "SystemId")
                        .HasDatabaseName("ix_orbiting_bodies_instance_id_system_id");

                    b.ToTable("orbiting_bodies", (string)null);
                });

            modelBuilder.Entity("GalaxyMapSiteApi.Models.OrbitingBodyGovernment", b =>
                {
                    b.Property<string>("InstanceId")
                        .HasColumnType("text")
                        .HasColumnName("instance_id");
                    ...
                    b.HasKey("InstanceId", "ChildId", "ParentId")
                        .HasName("pk_orbiting_body_governments");

                    b.HasIndex("InstanceId", "ParentId")
                        .HasDatabaseName("ix_orbiting_body_governments_instance_id_parent_id");

                    b.ToTable("orbiting_body_governments", (string)null);
                });
            ...
            modelBuilder.Entity("GalaxyMapSiteApi.Models.OrganizationOrganization", b =>
                {
                    ...
                    b.HasKey("InstanceId", "ChildId", "ParentId", "StartDate", "Relationship")
            ...
            modelBuilder.Entity("GalaxyMapSiteApi.Models.OrbitingBody", b =>
                {
                    b.HasOne("GalaxyMapSiteApi.Models.Instance", "Instance")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_orbiting_bodies_instances_instance_id");

                    b.HasOne("GalaxyMapSiteApi.Models.OrbitingBody", "OrbitedBody")
                        .WithMany()
                        .HasForeignKey("InstanceId", "OrbitedBodyId")
                        .HasConstraintName("fk_orbiting_bodies_orbiting_bodies_instance_id_orbited_body_id");

                    b.HasOne("GalaxyMapSiteApi.Models.System", "System")
                        .WithMany("OrbitingBodies")
                        .HasForeignKey("InstanceId", "SystemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_orbiting_bodies_solar_systems_instance_id_system_id");

                    b.Navigation("Instance");

                    b.Navigation("OrbitedBody");
            ...
            modelBuilder.Entity("GalaxyMapSiteApi.Models.OrbitingBodyGovernment", b =>
                {
                    b.HasOne("GalaxyMapSiteApi.Models.Instance", "Instance")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_orbiting_body_governments_instances_instance_id");

                    b.HasOne("GalaxyMapSiteApi.Models.OrbitingBody", "Child")
                        .WithMany()
                        .HasForeignKey("InstanceId", "ChildId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_orbiting_body_governments_orbiting_bodies_instance_id_child");
                    ...
                    b.HasOne("GalaxyMapSiteApi.Models.Government", "Parent")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_orbiting_body_governments_governments_instance_id_parent_id");
